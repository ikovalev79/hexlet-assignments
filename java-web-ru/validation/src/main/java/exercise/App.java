...
public final class App {
    ...
    public static Javalin getApp() {
        ...
        app.post("/articles", ctx -> {
            ...
            String titleForError = "";
            String contentForError = "";
          
            try {
              titleForError = ctx.formParam("title");
              contentForError = ctx.formParam("content");
              ...
              var page = new BuildArticlePage(titleForError, contentForError, e.getErrors());
              ctx.status(422);
              ctx.render("articles/build.jte", model("page", page));
          }
        });
